    ...
    children: [
      {
        ...
        pathMatch: 'full',
        data: { titulo: 'Categorias', subTitulo: 'Realiza o cadastro de novas categorias' }
      },
      {
        path: 'lugares',
      ...
      },
      {
        ...
        pathMatch: 'full',
        data: { titulo: 'Lista de lugares', subTitulo: 'Descubra os melhores lugares para se visitar' }
      }
    ]
  }
];
